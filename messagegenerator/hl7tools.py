...
def generate_hl7_message(practitioner, patient, tests, critical):
    ...
    hl7message.msh.msh_12 = str(random.randint(1, 100))
    ...
    for i, test in enumerate(tests):
        ...
        if i == 0:
            ...
            if critical:
                ...
                hl7message.ORU_R01_PATIENT_RESULT.ORU_R01_ORDER_OBSERVATION.ORU_R01_OBSERVATION.OBX.obx_6 = "N"
        else:
            ...
            if critical:
                ...
                hl7message.ORU_R01_PATIENT_RESULT[i].ORU_R01_ORDER_OBSERVATION.ORU_R01_OBSERVATION.OBX.obx_6 = "N"
        print_hl7_message(hl7message)

    print hl7message.validate()
